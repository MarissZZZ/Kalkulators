...
import numbers
import string
from tkinter import* # importē bibiliotēku
mansLogs=Tk()
...
btnC=Button(mansLogs,text='C',padx='39',pady='20', command=notirit)
btnVien=Button(mansLogs,text='=',padx='40',pady='20', command=vienads)
btnKom=Button(mansLogs,text='.',padx='41',pady='20')
btnPlusMin=Button(mansLogs,text='+/-',padx='34',pady='20', command=lambda:btnCommand("-"))
btnIek=Button(mansLogs,text='( )',padx='38',pady='20')
btnProc=Button(mansLogs,text='%',padx='38',pady='20')
